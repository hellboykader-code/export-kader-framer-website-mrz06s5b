...
This export embeds Framer's actual runtime (`react`, `motion`, `framer`, 449 chunks total, 51920 KB) so the page renders byte-for-byte identical to your live Framer site.

> Generated for **kader.framer.website** on 2026-07-24.
